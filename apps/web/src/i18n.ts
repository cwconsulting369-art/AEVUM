...
// AEVUM Web i18n — DE = Default-Markt, EN = internationale Version.
...
// Verwendung in Components: const { t } = useTranslation(); t('home.heroTitle')
...
if (typeof document !== 'undefined') {
  ...
  i18n.on('languageChanged', (l) => {
    ...
    try {
      ...
      /* localStorage nicht verfügbar — Sprache bleibt für die Session */
    }
  });
}
