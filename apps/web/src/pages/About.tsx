    ...
    <section className="px-6 lg:px-16 py-16" ref={ref}>
      <div className="max-w-[1440px] mx-auto">
        ...
        <motion.div
          ...
          className="bg-[#111116] border border-white/10 p-8 md:p-12"
        >
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
            <div className="flex flex-col items-center md:items-start flex-shrink-0">
              <div className="w-24 h-24 rounded-full bg-[#e0a458]/10 border-2 border-[#e0a458]/30 flex items-center justify-center mb-4">
                <User size={40} className="text-[#e0a458]" />
              </div>
              <h3 className="text-xl font-medium text-[#F9FAFB]">{CONTACT.name}</h3>
              <div className="flex items-center gap-1.5 text-sm text-[#a4a4ad] mt-1">
                <MapPin size={14} className="text-[#7a7a85]" />
                Augsburg, Deutschland
              </div>
            </div>

            <div className="flex-1">
              <p className="text-[#a4a4ad] leading-relaxed mb-8 text-base md:text-lg">
