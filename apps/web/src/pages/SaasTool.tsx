...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-white/8">
      ...
      >
        <span className="text-sm text-white group-hover:text-[#e0a458] transition-colors font-medium">{q}</span>
        <ChevronDown
          size={16}
          className={`text-white/40 group-hover:text-[#e0a458] transition-transform shrink-0 ${
            open ? 'rotate-180' : ''
          }`}
        />
      </button>
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center text-center px-6">
        <div>
          ...
          <h1 className="text-xl text-white font-light mb-2">SaaS-Tool nicht gefunden</h1>
          <p className="text-white/50 text-sm mb-6">Slug: <span className="font-mono">{slug}</span></p>
          <a
            href="#/saas"
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-8">
        <a
          href="#/saas"
          className="inline-flex items-center gap-1.5 text-xs font-mono uppercase tracking-wider text-white/50 hover:text-[#e0a458] transition-colors"
        >
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-2 flex-wrap mb-5">
              ...
              {isComingSoon && (
                <span className="inline-flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-wider px-2 py-0.5 rounded border bg-white/5 border-white/15 text-white/55">
                  <Clock size={10} />
                  {tool.statusLabel}
                </span>
              )}
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05] text-white mb-4">
              {tool.name}
            </h1>
            <p className="text-base md:text-lg text-white/60 leading-relaxed mb-6 max-w-3xl">
              {tool.tagline}
            </p>

            <div className="flex items-center gap-2 mb-8">
              <Coins size={16} className={isComingSoon ? 'text-white/30' : 'text-[#e0a458]'} />
              <span className={`text-sm font-mono ${isComingSoon ? 'text-white/40' : 'text-[#e0a458]'}`}>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {tool.demoOutput && (
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-3 border border-white/15 hover:border-white/30 text-white text-sm rounded transition"
                  >
                ...
                {tool.portalToolSlug && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-3 text-white/70 hover:text-white text-sm transition"
                  >
            ...
            {isComingSoon && (
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="text-xs text-white/40">Audit-Call buchen → Beta-Zugang</span>
              </div>
            )}
          </motion.div>
        </div>
      ...
      <section className="border-t border-white/5 py-14">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h2 className="text-2xl md:text-3xl font-light text-white mb-4">Use-Case</h2>
          <p className="text-base text-white/65 leading-relaxed">{tool.whatIsIt}</p>

          {tool.useCases.length > 0 && (
            <div className="mt-8">
              <div className="text-xs font-mono uppercase tracking-wider text-white/50 mb-3">Passt für</div>
      ...
      <section className="border-t border-white/5 py-14 bg-white/[0.015]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-white">Pipeline-Steps</h2>
          </div>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {tool.whatItDoes.map((s) => (
              <motion.div
                ...
                className="bg-[#0a0a0a] border border-white/8 rounded-lg p-5"
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-sm text-white font-medium">{s.title}</h3>
                </div>
        ...
        <section className="border-t border-white/5 py-14">
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white mb-2">{tool.demoOutput.title}</h2>
              ...
              {!demoOpen && (
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-sm text-white font-medium">Demo-Output zeigen</div>
                    <div className="text-xs text-white/50 mt-1">Vorschau · Statisch</div>
                  </div>
                </button>
              )}
              <pre className={`p-6 text-sm text-white/80 font-mono leading-relaxed whitespace-pre-wrap ${demoOpen ? '' : 'select-none'}`}>
      ...
      <section className="border-t border-white/5 py-14 bg-white/[0.015]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-white mb-3">Credit-Pakete</h2>
          ...
          <div className="grid gap-4 md:grid-cols-3 max-w-3xl mx-auto">
            {CREDIT_PACKAGES.map((pkg) => (
              <div
                key={pkg.slug}
                className={`relative bg-[#0a0a0a] border rounded-lg p-6 flex flex-col ${
              ...
              >
                ...
                <div className="text-center flex-1">
                  ...
                  <div className="text-3xl font-light text-white mb-1">€{pkg.priceEur}</div>
                  <div className="text-sm text-white/60 mb-2">{pkg.credits} Credits</div>
                  {pkg.bonusPct > 0 && (
                    <div className="font-mono text-[10px] uppercase tracking-wider text-emerald-400 mb-2">
                      +{pkg.bonusPct}% Bonus
                    </div>
                  )}
                  <div className="text-xs text-white/40 font-mono">{pkg.runsHint}</div>
                </div>
                {!isComingSoon && (
                  <button
        ...
        <section className="border-t border-white/5 py-14">
          <div className="max-w-3xl mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-white">Häufige Fragen</h2>
            </div>
            <div>
              {tool.faq.map((f, i) => (
      ...
      <section className="border-t border-white/5 py-16 text-center">
        <div className="max-w-2xl mx-auto px-6">
          {isComingSoon ? (
            <>
              <Lock size={24} className="mx-auto text-white/40 mb-4" />
