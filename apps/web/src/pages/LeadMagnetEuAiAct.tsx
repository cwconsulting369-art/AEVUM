                ...
                {success ? (
                  <div className="text-center py-4">
                    ...
                    <div className="mt-8 pt-6 border-t border-theme-border">
                      <p className="text-sm text-text-secondary mb-3">Nächster Schritt:</p>
                      <Button
                        asChild
                        variant="outline"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-start gap-3 pt-1">
                      ...
                      >
                        ...
                        meine Daten gemäss <a href="/#/datenschutz" className="text-theme-accent hover:underline">Datenschutzerklärung</a> verarbeitet.
      ...
      <section className="px-6 pb-16">
        <div className="max-w-4xl mx-auto p-5 rounded-lg border border-theme-border bg-bg-elevated">
          <p className="text-xs text-text-muted leading-relaxed">
            <strong className="text-text-secondary">Hinweis:</strong> Diese Checkliste ist eine
