        ...
        <div className="max-w-[1280px] mx-auto px-6 pt-40 pb-24">
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-6 font-mono text-xs" style={{ color: 'var(--text-muted)' }}>
              ...
              <span>/</span>
              <span style={{ color: 'var(--accent-amber)' }}>Audit</span>
            </div>
            ...
            <div className="flex items-baseline gap-2 mb-10">
              <span className="font-display text-5xl font-light" style={{ color: 'var(--accent-amber)' }}>
                &euro;1,299
              </span>
          ...
          >
            <div className="rounded-2xl border p-10 md:p-14" style={{ backgroundColor: 'var(--bg-surface)', borderColor: 'var(--border-subtle)' }}>
              <div className="text-center mb-10">
                {/* Price */}
                <div className="mb-2">
                  <span className="font-display text-[clamp(48px,5vw,64px)] font-light" style={{ color: 'var(--accent-amber)' }}>
                    &euro;1,299
                  </span>
                </div>
