...
function Hero() {
  return (
    ...
    >
      {/* Amber accent line */}
      <div className="absolute top-0 left-0 right-0 h-[2px]" style={{ background: 'linear-gradient(90deg, transparent, var(--accent-amber), transparent)' }} />
      ...
      <div className="max-w-[1280px] mx-auto px-6 pt-32 pb-20 w-full">
        ...
        >
          ...
          <div className="flex items-center gap-2 font-mono text-xs mb-6" style={{ color: 'var(--text-muted)' }}>
            <a href="#/" className="hover:text-[var(--accent-amber)] transition-colors duration-200">Services</a>
            <span>/</span>
            <span style={{ color: 'var(--accent-amber)' }}>Sales OS</span>
          </div>
          ...
          <h1 className="font-display font-light tracking-tight" style={{ fontSize: 'clamp(48px, 6vw, 96px)', lineHeight: 0.95, letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>
            Sales<span className="text-[var(--accent-amber)]">OS</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-10">
            <div className="font-mono text-sm" style={{ color: 'var(--text-secondary)' }}>
              <span className="text-[var(--accent-amber)] font-medium" style={{ fontSize: '18px' }}>€2,499</span>
              {' '}Setup +{' '}
              <span className="text-[var(--accent-amber)] font-medium" style={{ fontSize: '18px' }}>€399</span>
              /month
            </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        >
          <h2 className="font-display text-[clamp(32px,4vw,64px)] font-normal" style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}>
            Sales admin eats <span className="text-[var(--accent-amber)]">70%</span> of sales time.
          </h2>
        </motion.div>
                      ...
                      {col.cards.map((card, i) => (
                        <motion.div
                          ...
                          style={{
                            backgroundColor: 'var(--bg-surface)',
                            borderColor: 'var(--border-subtle)',
                            borderLeft: col.closed ? '2px solid var(--success)' : '1px solid var(--border-subtle)',
                          }}
                        >
    ...
    <section className="py-[140px] md:py-[180px]" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <div className="max-w-[1280px] mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <h2 className="font-display text-[clamp(32px,4vw,64px)] font-normal" style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}>
            Everything you need to <span className="text-[var(--accent-amber)]">close deals</span>
          </h2>
        </motion.div>
    ...
    <section className="py-[100px] md:py-[140px]" style={{ backgroundColor: 'var(--bg-accent-wash)' }}>
      <div className="max-w-[1280px] mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <h2 className="font-display text-[clamp(32px,4vw,64px)] font-normal" style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}>
            Built on modern <span className="text-[var(--accent-amber)]">infrastructure</span>
          </h2>
        </motion.div>
          ...
          >
            <div className="text-center mb-8">
              <div className="flex items-baseline justify-center gap-1 mb-2">
                <span className="font-mono font-medium" style={{ fontSize: '18px', color: 'var(--accent-amber)' }}>
                  €2,499
                </span>
    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 text-center" ref={ref}>
        ...
        >
          ...
          >
            14 days <span className="text-[var(--accent-amber)]">free.</span>
          </h2>
      ...
      <div className="max-w-[1280px] mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <h2 className="font-display text-[clamp(28px,3vw,48px)] font-normal" style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}>
            Explore more <span className="text-[var(--accent-amber)]">solutions</span>
          </h2>
        </motion.div>
            ...
            return (
              <motion.div key={service.name} variants={staggerItem}>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 font-mono text-xs uppercase tracking-[0.08em]" style={{ color: 'var(--accent-amber)' }}>
                    Learn more
