  ...
  return (
    <div className="min-h-screen bg-ink-950 text-ink-100">
      ...
      <section className="px-4 sm:px-6 py-12 sm:py-16 max-w-3xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-light tracking-tight mb-2">Nutzungsbedingungen</h1>
        ...
        <article className="space-y-10 text-neutral-400 leading-relaxed break-words">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">1. Geltungsbereich</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">2. Vertragspartner</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">3. Zugang</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">4. Nutzungsumfang</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">5. API-Schlüssel</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">6. Verfügbarkeit</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">7. Haftung</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">8. Kündigung &amp; Account-Löschung</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">9. Anwendbares Recht</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-light text-neutral-100 mb-3">10. Änderungen</h2>
            <p>
