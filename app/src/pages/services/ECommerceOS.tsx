      ...
      <div className="max-w-[1280px] mx-auto px-6 pt-32 pb-20 w-full">
        ...
        >
          ...
          <div className="flex items-center gap-2 font-mono text-xs mb-6" style={{ color: 'var(--text-muted)' }}>
            <Link to="/" className="hover:text-[var(--accent-primary)] transition-colors duration-200">
              Services
            </Link>
            <span>/</span>
            <span style={{ color: 'var(--accent-primary)' }}>E-Commerce OS</span>
          </div>

          {/* Label */}
          <div className="section-label mb-4">KetoLabsOS Edition</div>
          ...
          >
            E-Commerce<span className="text-[var(--accent-primary)]">OS</span>
          </h1>
          ...
          >
            Complete e-commerce operating system. Shop, inventory, payments, customer automation, analytics. One system for everything.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-10">
            <div className="font-mono text-sm" style={{ color: 'var(--text-secondary)' }}>
              <span className="text-[var(--accent-primary)] font-medium" style={{ fontSize: '18px' }}>
                €2,999
              </span>{' '}
              Setup +{' '}
              <span className="text-[var(--accent-primary)] font-medium" style={{ fontSize: '18px' }}>
...
const problemCards = [
  {
    ...
    body: 'Shop, inventory, payments, email, support — all separate. No connection.',
    stat: '5+',
  ...
  },
  {
    ...
    body: 'Process orders manually. Update inventory by hand. No automation.',
    stat: '15h+',
    statLabel: 'per week manual work',
  },
  {
    icon: UserX,
    title: 'Data Silos',
    body: 'Purchase history in one tool. Support in another. No 360-degree customer view.',
    stat: '0%',
    statLabel: 'of customer data connected',
  },
]
    ...
    <section className="py-[140px] md:py-[180px]" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        >
          ...
          >
            <span className="text-[var(--accent-primary)]">5+</span> tools.{' '}
            <span className="text-[var(--accent-primary)]">No</span> automation.{' '}
            <span className="text-[var(--accent-primary)]">No</span> overview.
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2
              ...
              style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}
            >
              One System. The <span className="text-[var(--accent-primary)]">Complete</span> Shop.
            </h2>
            <p
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          ...
                          style={{
                            color: row.status === 'In Stock' ? 'var(--success)' : 'var(--accent-primary)',
      ...
      <div className="max-w-[1280px] mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <h2
            ...
            style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}
          >
            Everything to <span className="text-[var(--accent-primary)]">run your shop</span>
          </h2>
        </motion.div>
      ...
      <div className="max-w-[1280px] mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <h2
            ...
            style={{ color: 'var(--text-primary)', lineHeight: 1.0, letterSpacing: '-0.01em' }}
          >
            Powered by <span className="text-[var(--accent-primary)]">enterprise tech</span>
          </h2>
        </motion.div>
      ...
      <div className="max-w-[1280px] mx-auto px-6" ref={ref}>
        ...
        >
          ...
          >
            ...
            <div
              className="mb-8"
              style={{ borderTop: '1px solid var(--border-primary)', paddingTop: '24px' }}
            >
              <div
    ...
    <section className="py-[120px] md:py-[160px]" style={{ backgroundColor: 'var(--bg-accent-wash)' }}>
      <div className="max-w-[1280px] mx-auto px-6 text-center" ref={ref}>
        ...
        >
          ...
          >
            See KetoLabsOS <span className="text-[var(--accent-primary)]">live.</span>
          </h2>
          <p
            className="font-body text-lg max-w-md mx-auto mb-10"
            style={{ color: 'var(--text-secondary)', lineHeight: 1.65 }}
          >
            A complete e-commerce system in production.
          </p>
          <Link to="/contact" className="btn-primary inline-flex items-center gap-2">
            Start Live Demo
            <ArrowRight size={16} />
